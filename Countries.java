...
public class Countries {
    ...
    public void page() {
        ...
        int accA = 0;
        try {
            br = new BufferedReader(new FileReader("CountriesQuestions.txt"));
        ...
        try {
            br = new BufferedReader(new FileReader("CountriesAnswers.txt"));
        ...
        Scores score = new Scores("Countries", 0, Questions.size());
