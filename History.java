...
public class History {
    ...
    public void page() {
        ...
        int accA = 0;
        try {
            br = new BufferedReader(new FileReader("HistoryQuestions.txt"));
        ...
        try {
            br = new BufferedReader(new FileReader("HistoryAnswers.txt"));
        ...
        Scores score = new Scores("History", 0, Questions.size());
