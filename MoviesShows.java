...
public class MoviesShows {
    ...
    public void page() {
        ...
        int accA = 0;
        try {
            br = new BufferedReader(new FileReader("MoviesShowsQuestions.txt"));
        ...
        try {
            br = new BufferedReader(new FileReader("MoviesShowsAnswers.txt"));
        ...
        Scores score = new Scores("Movies/Shows", 0, Questions.size());
