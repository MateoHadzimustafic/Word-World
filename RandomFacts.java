...
public class RandomFacts {
    ...
    public void page() {
        ...
        int accA = 0;
        try {
            br = new BufferedReader(new FileReader("RandomFactsQuestions.txt"));
        ...
        try {
            br = new BufferedReader(new FileReader("RandomFactsAnswers.txt"));
        ...
        Scores score = new Scores("Random Facts", 0, Questions.size());
