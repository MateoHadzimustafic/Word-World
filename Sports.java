...
public class Sports {
    ...
    public void page() {
        ...
        int accA = 0;
        try {
            br = new BufferedReader(new FileReader("SportQuestions.txt"));
        ...
        try {
            br = new BufferedReader(new FileReader("SportAnswers.txt"));
        ...
        Scores score = new Scores("Sports", 0, Questions.size());
